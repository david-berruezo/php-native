                        ...
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    ...
                                    <span class="total text-center">Esp|Cat</span>
                                    <span class="title text-center">MultiIdioma</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel widget-mini">
                                <div class="panel-body">
                                    ...
                                    <span class="total text-center">Php Cookies | Html</span>
                                    <span class="title text-center">Cookies Multidioma</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel widget-mini">
                                <div class="panel-body">
                                    ...
                                    <span class="total text-center">Códigos Postales</span>
                                    <span class="title text-center">Validación</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    <i class="icon-user"></i>
                                    <span class="total text-center">Google Maps</span>
                                    <span class="title text-center">Según código postal</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    <i class="icon-bar-chart"></i>
                                    <span class="total text-center">Detección movil</span>
                                    <span class="title text-center">Sistema Operativo</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel widget-mini">
                                <div class="panel-body">
                                    <i class="icon-support"></i>
                                    <span class="total text-center">SMS</span>
                                    <span class="title text-center">Envío SMS</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    <i class="icon-user"></i>
                                    <span class="total text-center">Envío SMS</span>
                                    <span class="title text-center">Según Idioma</span>
                                </div>
                            </div>
                        </div>
                    </div>
