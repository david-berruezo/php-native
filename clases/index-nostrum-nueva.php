...
<head>
    ...
    <title>Aplicaciones Noves Idees ADR</title>
...
<section id="main-wrapper" class="theme-default">
    <header id="header">
        ...
        <div class="brand">
            <a href="index.html" class="logo">
                ...
                <span>Aplicaciones</span>NovesIdees ADR</a>
        </div>
        <!--logo end-->
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active">
                    <a href="#" title="Dashboard">
                        <i class="fa  fa-fw fa-tachometer"></i> Empresas
                    </a>

                </li>
                <li class="nav-dropdown">
                    <a href="#" title="UI Elements">
                        <i class="fa  fa-fw fa-cogs"></i> CityXerpa
                    </a>
                    <ul class="nav-sub">
                        <li>
                            <a href="index-landing-nueva.html" title="Buttons">
                                Landing Xerpa Nueva
                            </a>
                        </li>
                        <li>
                            <a href="index-landing-nueva.html" title="Sliders &amp; Progress">
                                Landing Xerpa
                            </a>
                        </li>
                        <li>
                            <a href="index-landing-nueva.html" title="Modals &amp; Popups">
                                Landing Xerpa Buscador
                            </a>
                        </li>
                        <li>
                            <a href="index-landing-nueva.html" title="Tabs &amp; Accordions">
                                Landing Xerpa Buscador Online
                            </a>
                        </li>

                        <li>
                            <a href="index-landing-nueva.html" title="Alerts &amp; Notifications">
                                Landing Xerpa David
                            </a>
                        </li>
                        <li>
                            <a href="index-landing-nueva.html" title=" Nestable Lists">
                                Landing Xerpa Servidor
                            </a>
                        </li>

                        <li>
                            <a href="index-landing-nueva.html" title="Icons">
                                Landing Xerpa Sonia
                            </a>
                        </li>
                        <li>
                            <a href="index-landing-nueva.html" title="Typography">
                                Landing Xerpa Última
                            </a>
                        </li>
                        <li>
                            <a href="index-reservas-nueva.html" title="Typography">
                                Registra tu negocio en CityXerpa
                            </a>
                        </li>
                        <li>
                            <a href="index-reservas-nueva.html" title="Typography">
                                Trabaja en CityXerpa com repartidor
                            </a>
                        </li>
                        <li>
                            <a href="index-reservas-nueva.html" title="Typography">
                                Sistema de reserves motoristes CityXerpa Usuari
                            </a>
                        </li>
                        <li>
                            <a href="index-reservas-nueva.html" title="Typography">
                                Sistema de reserves motoristes CityXerpa Admin
                            </a>
                        </li>
                        <li>
                            <a href="index-nostrum-nueva.php" title="Typography">
                                Bajada de imágenes Nostrum
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-dropdown">
                    <a href="#" title="Forms">
                        <i class="fa  fa-fw fa-edit"></i> TedClothing
                    </a>
                    <ul class="nav-sub">
                        <li><a href="llegatarde" title="LlegaTardeOriginal">Estadísticas Llega Tarde Original</a>
                        </li>
                        <li><a href="enviatarde" title="EnviaTardeOriginal">Estadísticas Envía Tarde Original</a>
                        </li>
                        <li><a href="enviatardeproductos" title="EnviaTardeProductos">Estadísticas Envía Tarde Productos</a>
                        </li>
                        <li><a href="aplicaciones" title="Estadísticas1">Estadísticas 1 (Envía tarde y +)</a>
                        </li>
                        <li><a href="estadisticas"s title="Estadísticas2">Estadísticas 2 (Top Quinze y +)</a>
                        </li>
                        <li><a href="borrarimagenes" title="BorrarImágenes">Borrar Imágenes repetidas</a>
                        </li>
                        <li><a href="index-cms-ted.html" title="PáginasCMS">Páginas CMS per TED.CLOTHING</a>
                        </li>
                        <li><a href="index-coming-soon-ted.html" title="Comingsoon">Coming soon TED.CLOTHING</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="imagenesiguales">Detectar Imágenes Iguales</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="ponercover">Ponémos en Cover la imagen 1</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="productlikes">Ponémos Product Likes Aleatorio</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="referenciasiguales">Detectamos referéncias iguales tb podémos borrarlas</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="atualizacionprecios">Actualización precios (sql)</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="borrarproducto">Borrar producto (sql)</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="estadisticassql">Estadisticas (sql)</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="paymentaccepetedtoshipped">Payment Accepted To Shipped (sql)</a>
                        </li>
                        <li><a href="index-scripts-ted.html" title="paymentaccepetedtoshipped2">Payment Accepted To Shipped2 (sql)</a>
                        </li>
                        <li><a href="index-template-emails-ted.html" title="templateemails">Template emails</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-dropdown">
                    <a href="#" title="Tables">
                        <i class="fa  fa-fw fa-th-list"></i> MakeYourSuit
                    </a>
                    <ul class="nav-sub">
                        <li>
    ...
    <section class="main-content-wrapper">
        <div class="pageheader">
            <h1>CITYXERPA Landing Page</h1>
            <p class="description">Bienvenido a CityXerpa landing page</p>
        ...
        <section id="main-content" class="animated fadeInUp">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <img src="assets/img/logocityxerpa.jpg" class="img-responsive foto">
                    <div class="img-responsive room">
                        <ul>
                            <li>Landing</li>
                            <li>Sistema de reservas</li>
                            <li>Imágenes Nostrum</li>
                        </ul>
                    </div>
                </div>

                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 cuadro">
                    <a href="nostrum"><img src="assets/img/nostrum.jpg" class="img-responsive foto"></a>
                    <a href="nostrum"><h1>NOSTRUM</h1></a>
                    <a href="nostrum">
                        <div class="img-responsive room">
                            <p>
                                Script para descargar todas las imagenes de nostrum.
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <p><a href="#" style="font-size:16px;">Que deseas hacer ?</a></p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <p><a href="index-nostrum-script.php" style="font-size:16px;">1.- Pincha aqui para ver las imagenes de Nostrum descargadas</a></p>
                </div>
            </div>

            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <p><a href="nostrum/index.php" style="font-size:16px;">2.- Pincha aqui para ejecutar el script para descargar imágenes de Nostrum otra vez</a></p>
                </div>
            </div>

            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <p><a href="nostrum/codigo.zip" style="font-size:16px;">3.- Pincha aqui para descargar el script de Nostrum</a></p>
                </div>
            </div>
        </section>
        ...
        <section id="main-content" class="animated fadeInUp">
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12">
                    <h1>Funcionalidades de del script Nostrum</h1>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    ...
                                    <span class="total text-center">Adquirimos datos</span>
                                    <span class="title text-center">Nostrum</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel widget-mini">
                                <div class="panel-body">
                                    ...
                                    <span class="total text-center">Bajamos Imágenes</span>
                                    <span class="title text-center">Guardamos Imágenes</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel widget-mini">
                                <div class="panel-body">
                                    ...
                                    <span class="total text-center">Número de Imágenes</span>
                                    <span class="title text-center">294</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    <i class="icon-user"></i>
                                    <span class="total text-center">Se puede incrementar</span>
                                    <span class="title text-center">Imágenes Bajadas</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    <i class="icon-bar-chart"></i>
                                    <span class="total text-center">Automáticamente</span>
                                    <span class="title text-center">lee carpeta Imágenes</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel widget-mini">
                                <div class="panel-body">
                                    <i class="icon-support"></i>
                                    <span class="total text-center">Actualizable a</span>
                                    <span class="title text-center">Otras Carpetas</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel widget-mini">
                                <div class="panel-body">
                                    <i class="icon-envelope-open"></i>
                                    <span class="total text-center">Android|IOS</span>
                                    <span class="title text-center">Descarga Aplicaciones</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel panel-solid-success widget-mini">
                                <div class="panel-body">
                                    <i class="icon-user"></i>
                                    <span class="total text-center">Clase</span>
                                    <span class="title text-center">cURL</span>
                                </div>
                            </div>
                        </div>
                    </div>
