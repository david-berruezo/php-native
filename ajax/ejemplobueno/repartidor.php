...
<body id="page-top">
<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12" class="img-responsive" style="background-image:url('imagenes/prueba2.jpg');height:300px;background-size:cover;background-position:0px -400px;background-repeat: no-repeat;margin:0px;padding:0px;"></div>
    ...
    <div class="page-form">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12" style="margin-top:30px;">
                <?php if ($idioma == "esp") { ?>
                    <h3 style="color:#000000;font-family:Times;">QUIERO SER REPARTIDOR</h3>
                <?php }else{ ?>
                    <h3 style="color:#000000;font-family:Times;">VULL SER REPARTIDOR</h3>
                <?php } ?>
                <hr class="barra">
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                <form id="indexForm" method="post" action="http://www.google.com">
                    <div class="form-group">
                        <input type="text" class="form-control" required id="name" name="name" placeholder="<?php if ($idioma == "esp") { ?>Nombre<?php }else{ ?>Nom<?php } ?>">
                    ...
                    <div class="form-group">
                        <select class="form-control">
                            <option selected="selected"><?php if ($idioma == "esp") { ?>¿Que vehículo usararás ?<?php }else{ ?>¿Quin vehícle utilitzarás ?<?php } ?></option>
                            <option><?php if ($idioma == "esp") { ?>Coche<?php }else{ ?>Cotxe<?php } ?></option>
                            <option>Bicicleta</option>
                            <option>Motocicleta</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" required name="message" id="message" rows="3" placeholder="<?php if ($idioma == "esp") { ?>Mensaje<?php }else{ ?>Missatge<?php } ?>"></textarea>
                        <p style="color:#9b1a1a" id="messagemessage" name="messagemessage"></p>
                    </div>
                    <!--<button type="submit" class="btn btn-default" style="float:right;margin-top:10px;">Enviar</button>-->
                    <input class="btn btn-default" type="submit" value="Enviar" id="enviarRepartidor" name="enviarRepartidor">
