...
class ObjectFerreteria {
    ...
    public function setIndexContent($vectorContent){
        ...
        $this->leerUrls($this->indexContent);
    ...
    public function setHijoContent($vectorContent){
        $this->hijoContent = $vectorContent;
    }
    ...
    public function setNietoContent($vectorContent){
        $this->nietoContent = $vectorContent;
        $this->guardarDatos();
    }
    ...
    public function crearProducto($i,$desc,$url){
        $producto                      = array();
        $producto["url"]               = $url;
        $producto["ID"]                = $i;
        $producto["Name"]              = "";
     ...
     * caracteristicas... etc
     */
     public function updateProducts($contadorProducto){
         $contadorPadre         = 0;
         $contadorHijo          = 0;
         $contadorNieto         = 0;
         $indiceProducto        = 0;
         $contadorProductoHijo  = 0;
         $contadorProductoNieto = 0;
         $nombreFichero         = 'products_import'.$contadorProducto.'.csv';
         ...
         foreach ($this->categoriaPrincipal as $padre){
                foreach($padre["hijos"] as $hijo){
                    foreach($hijo["productos"] as $producto){
                        if ($indiceProducto >= $contadorProducto * 500 &&  $indiceProducto < (($contadorProducto + 1) * 500) ){
                            $vectorCsv = $this->setUpdateProductsHijos($contadorPadre,$contadorHijo,$contadorNieto,$indiceProducto,$this->productoContent[$indiceProducto],$contadorProductoHijo);
                            array_push($vectorProductos,$vectorCsv);
                        }
                        $indiceProducto++;
                        $contadorProductoHijo++;
                    }
                    foreach($hijo["nietos"] as $nieto){
                        foreach($nieto["productos"] as $producto){
                            if ($indiceProducto >= $contadorProducto * 500 &&  $indiceProducto < (($contadorProducto + 1) * 500) ){
                                $vectorCsv = $this->setUpdateProductsNietos($contadorPadre,$contadorHijo,$contadorNieto,$indiceProducto,$this->productoContent[$indiceProducto],$contadorProductoNieto);
                                array_push($vectorProductos,$vectorCsv);
                            }
                            $indiceProducto++;
                            $contadorProductoNieto++;
                        }
                        $contadorProductoNieto = 0;
                        $contadorNieto++;
                    }
    ...
    * caracteristicas... etc
    */
    public function setUpdateProductsHijos($contadorPadre,$contadorHijo,$contadorNieto,$indiceProducto,$content,$contadorProductoHijoNieto){
        $nombre          = $this->queryGetNameAndReference($content);
        $images          = $this->queryGetImages($content);
        $priceVector     = $this->queryGetPriceAndOldPrice($content);
        $vectorCarac     = $this->queryGetCaracteristicas($content);
        $marca           = $this->queryGetMarca($content);
        ...
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Name"]            = $nombre;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Price"]           = $price;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Wholesale price"] = $Wholesale;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["ImageUrls"]       = $images;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Tags"]            = $nombre;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Feature"]         = $caracteristicas;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Manufacturer"]    = $marca;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Description"]     = $descripcion;
        $vectorCsv = $this->writeCsvFieldsProductos($this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["ID"],$nombre,$this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["id"],$this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["ID"],$images,$Wholesale,$price,$caracteristicas,$descripcion,$marca,$this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["productos"][$contadorProductoHijoNieto]["Short description"]);
        return $vectorCsv;
    }
    ...
    * caracteristicas... etc
    */
    public function setUpdateProductsNietos($contadorPadre,$contadorHijo,$contadorNieto,$indiceProducto,$content,$contadorProductoHijoNieto){
        $nombre          = $this->queryGetNameAndReference($content);
        $images          = $this->queryGetImages($content);
        $priceVector     = $this->queryGetPriceAndOldPrice($content);
        $marca           = $this->queryGetMarca($content);
        ...
        $caracteristicas = $vectorCarac["carac"];
        $descripcion     = $vectorCarac["desc"];;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Name"]            = $nombre;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Price"]           = $price;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Wholesale price"] = $Wholesale;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["ImageUrls"]       = $images;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Tags"]            = $nombre;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Feature"]         = $caracteristicas;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Manufacturer"]    = $marca;
        $this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Description"]     = $descripcion;
        $vectorCsv = $this->writeCsvFieldsProductos($this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["ID"],$nombre,$this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["id"],$this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["ID"],$images,$Wholesale,$price,$caracteristicas,$descripcion,$marca,$this->categoriaPrincipal[$contadorPadre]["hijos"][$contadorHijo]["nietos"][$contadorNieto]["productos"][$contadorProductoHijoNieto]["Short description"]);
        return $vectorCsv;
    }
