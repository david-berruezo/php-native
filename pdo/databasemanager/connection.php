...
class Connection
{
	...
	public function MySQL($params)
	{
		...
		try
		{
			...
			//$connection = new PDO("mysql:host=$host;dbname=$database,root,$pwd");
			$usuario    = "root";
			$contraseña = "Berruezin23";
			$connection = new PDO('mysql:host=localhost;dbname=davidber_web', $usuario, $contraseña);
			var_dump($connection);
			//;mysql:localhost=dbname=davidber_web;host=localhost;port=3306;user=davidber_usuario;password=Berruezin23
			return $connection;
		}
		catch (PDOException $e)
		{
