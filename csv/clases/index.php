...
//$writer = Writer::createFromFileObject("fichero.csv"); //the CSV file will be created using a temporary File
$writer = Writer::createFromPath(new SplFileObject('file.csv', 'a+'), 'w');
