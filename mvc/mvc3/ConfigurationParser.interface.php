 ...
 * File:		ConfigurationParser.interface.php
 *
...
/**
 * This interface must be implemented by any configuration's parser classes
 *
 * @name IConfigurationParser
 * @version 1.0.0
...
/**
 * Configuration file parse exception
 * @package web.framework
 * @subpackage exceptions 
 */
class WF_ConfigurationParser_Exception extends Exception {}
