...
// Version 1.09 - 03-Jul-2016 - added Google API key support
  ...
  $Version = 'quake-json.php V1.09 - 03-Jul-2016';
...
//
// settings: --------------------------------------------------------------------
// As of 1-Jul-2016, you need a Google Browser JavaScript API KEY to run this script
//
...
*/
// and you won't need to change the $googleAPI value above (nor any of the other
...
';
	print "</script>\n";
?>
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $googleAPI;?>&amp;callback=initialize&amp;language=<?php print $Lang; ?>" type="text/javascript"></script>
<?php
