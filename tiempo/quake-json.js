...
// Version - 1.01 - 07-Aug-2016 - fixed window.onload interference with sorttable
//
...
var sorttable_oldOnLoad = window.onload;
...
if (typeof window.onload !== 'function') {
  ...
  window.onload = function() {
	sorttable_oldOnLoad();  // load original window.onload function first
	sorttable.init;
  };
